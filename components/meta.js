...
export default function Meta(props) {
	return (
		<Head>
			...
			<meta property="og:site_name" content="abdulbasir" key="ogsitename" />

			{/* meta information for twitter */}
			<meta name="twitter:card" content="abdulbasir" key="twcard" />
			<meta name="twitter:site" content="@abdulbasir27" key="twsite" />
			...
			<title>
				...
				{
					"ড. আব্দুল বাসির বিন নওশাদ অফিসিয়াল ওয়েবসাইট - Official website of Dr. Abdul Basir Bin Nawshad"
				}
			</title>
